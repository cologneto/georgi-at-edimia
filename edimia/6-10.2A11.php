...
<html lang="en"> 
    <head>
        ...
        <script src="assets/js/module.exercise_6-10-2A11.js"></script>
        <script src="assets/js/module.answer_0-5-A.js"></script>
        <script src="assets/js/module.progress.js"></script>
        <script src="assets/js/module.numberline.js"></script>
            ...
            $(function() {
                ...
                exercise.init({
                    ...
                    callback: function() {
                        ...
                        _helper.answer_arrows_handler(".exe-container-question");
