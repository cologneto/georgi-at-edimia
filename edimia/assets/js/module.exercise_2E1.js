var exercise = {
    ...
    init: function() {
        ...
        var aConfigClasses = [
            "c2E1",
            "layout no-header clickbuttons-two"
        ];
    ...
    set: function() {
        ...
        _helper.randomPair();
        var aAnswers = [exercise.generated_numbers[0] + "+" + exercise.generated_numbers[1], exercise.generated_numbers[0] + "-" + exercise.generated_numbers[1]]
        
        
       
        
        $(".exe-container-question").data("value", exercise.generated_numbers[0] + exercise.params.operationSign + exercise.generated_numbers[1]).html( 
            twig({ref: "equation"}).render({
                classname: "layout-0011",               
                num2class: "has-text large",
                num2: eval(exercise.generated_numbers[0] + exercise.params.operationSign + exercise.generated_numbers[1]), 
                imgstr2: eval(exercise.generated_numbers[0] + exercise.params.operationSign + exercise.generated_numbers[1]) + " =",            
