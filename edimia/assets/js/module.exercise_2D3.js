var exercise = {
    ...
    set: function() {
        ...
        numberline.updateArches( false, false,  exercise.generated_numbers[0]);
        ...
        $(".exe-container-header").append( twig({ref: "numberline"}).render() ).show();
            ...
            $("#slider a").hide();
            $("#slider").append("<a href=\"#\" class=\"ui-slider-handle ui-state-default ui-corner-all\" style=\"left: " +exercise.generated_numbers[0] +"0%;\"></a>");        
            $("#slider").append("<a href=\"#\" class=\"ui-slider-handle ui-state-default ui-corner-all\" style=\"left: " +exercise.generated_numbers[1] +"0%;\"></a>");
