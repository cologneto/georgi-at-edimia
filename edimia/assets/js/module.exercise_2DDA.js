var exercise = {
    ...
    set: function() {
        ...
        var numbs = [_helper.rangeRandom(1,exercise.params.max)];
        numbs.push(_helper.rangeRandomSkipUsed(1,exercise.params.max,numbs));
        numbs.push(_helper.rangeRandomSkipUsed(1,exercise.params.max,numbs));
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
            ...
            })).data("value",numbs[0] - second).addClass("space-top")
        );  
        ...
        $(".exe-container-question").append( 
         ...
         $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
            ...
            })).data("value",numbs[2] - second).addClass("space-top")
        );  
