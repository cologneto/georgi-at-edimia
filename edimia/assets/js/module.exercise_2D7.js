var exercise = {
    ...
    set: function() {
        ...
        var result = exercise.generated_numbers[0] + exercise.generated_numbers[1];
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
            ...
            })).attr("data-value",exercise.generated_numbers[1]).addClass("space-top")
        );
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
            ...
            })).attr("data-value",exercise.generated_numbers[0]).addClass("space-top")
        );
