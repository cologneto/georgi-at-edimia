var exercise = {
    ...
    init: function() {
        ...
        var aConfigClasses = [
            "c0-5-d8",
            "layout float fluid cols-2 col-w55 no-header" 
        ];
    ...
    set: function() {
        ...
        $(".exe-container-question").data("value", exercise.generated_numbers[0] - exercise.generated_numbers[1])
                .html( twig({ref: "equation"}).render({
                    classname :' layout-0011 small-signs padding-top-20',
                    num1: '',
                    imgstr1: '',
        ...
        $(".exe-container-answer")
                .append( $(twig({ref: "answercontainer"}).render({classname: 'answer-border ui-droppable smaller-width '})).data("value", exercise.generated_numbers[0] ) )
                .append( $(twig({ref: "answercontainer"}).render({classname: 'answer-border ui-droppable smaller-width '})).data("value", exercise.generated_numbers[1] ) )
                .append( $(twig({ref: "answercontainer"}).render({classname: 'answer-border ui-droppable smaller-width '})).data("value", exercise.generated_numbers[2] ) );
