var exercise = {
    ...
    init: function() {
        ...
        var aConfigClasses = [
            "c0-5-d9",
            "layout no-header question-answer" 
        ];
    ...
    set: function() {
        ...
        $(".exe-container-question").data("value", exercise.generated_numbers[1])
                .html( twig({ref: "equation"}).render({
                    classname: 'layout-1111 narrow-signs underlining-right one-row-question-answer',
        ...
        $(".exe-container-question").append(
                twig({ref: "answercontainer"}).render({classname: "animated bounceInLeft has-text large value" + parseInt( exercise.generated_numbers[0] - exercise.generated_numbers[1] )})
            );
