    ...
    set: function() {
        ...
        $(".exe-container-question").append(
                    $( twig({ref: "equation"}).render({
                        ...
                        num1: exercise.generated_numbers[0] - exercise.generated_numbers[1]
        ...
        $(".exe-container-answer")
                .append($(twig({ref: "button"}).render({value: aAnswers[0], intvalue: aAnswers[0] })).data( "value", aAnswers[0] ))
                .append($(twig({ref: "button"}).render({value: aAnswers[1], intvalue: aAnswers[1] })).data( "value", aAnswers[1] ))
                .append($(twig({ref: "button"}).render({value: aAnswers[2], intvalue: aAnswers[2] })).data( "value", aAnswers[2] ));                
    },
    solve: function() {
