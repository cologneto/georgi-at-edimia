    ...
    set: function() {
        ...
        $(".exe-container-question").data("value",exercise.generated_numbers[1]).html(
                    $( twig({ref: "equation"}).render({
                        classname: 'layout-11111',
                        num1class: 'has-text large',
                        num2class: 'underlining',
                        ...
                        num3: exercise.generated_numbers[0] + exercise.generated_numbers[1],
        ...
        $(".exe-container-answer")
                .append($(twig({ref: "button"}).render({classname: "two-line-dots-answer",value: aAnswers[0], intvalue: aAnswers[0], numberdots: exercise.params.bShowNumbrDots?"number-dots":"" })).data( "value", aAnswers[0] ))
                .append($(twig({ref: "button"}).render({classname: "two-line-dots-answer",value: aAnswers[1], intvalue: aAnswers[1], numberdots: exercise.params.bShowNumbrDots?"number-dots":"" })).data( "value", aAnswers[1] ))
                .append($(twig({ref: "button"}).render({classname: "two-line-dots-answer",value: aAnswers[2], intvalue: aAnswers[2], numberdots: exercise.params.bShowNumbrDots?"number-dots":"" })).data( "value", aAnswers[2] ));
    },
    solve: function() {
