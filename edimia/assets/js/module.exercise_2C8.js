var exercise = {
    ...
    set: function() {
        ...
        _helper.randomSequence(4);
        var equations = _helper.array_shuffle([
            numb + "-" + (numb-exercise.generated_numbers[0]),
            numb + "-" + (numb-exercise.generated_numbers[1]),
            numb + "-" + (numb-exercise.generated_numbers[2]),
            numb + "-" + (numb-exercise.generated_numbers[3])
        ]);
