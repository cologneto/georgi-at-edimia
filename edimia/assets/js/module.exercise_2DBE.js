var exercise = {
    ...
    set: function() {
        ...
        var numbs = [_helper.rangeRandom(6,10)];
        numbs.push(_helper.rangeRandomSkipUsed(6,10,numbs));
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
                ...
                imgstr3: eval(numbs[0] - second),
                mathSignOperator: "-"
                
            })).addClass("space-top")
        );  

         $(".exe-container-question").data("value",numbs[1] - second).append( 
           $( twig({ref: "equation"}).render({
                classname: "",
                num1class: "has-text large",
                num2class: "has-text large",              
