    ...
    set: function() {
        ...
        $(".exe-container-question").data("value", exercise.generated_numbers[0] + exercise.generated_numbers[1])
                .html( twig({ref: "equation"}).render({
                        classname: "layout-1010 text-center",
                        imgstr1: twig({ref: "imageholder"}).render({imgsrc: oImg.html(exercise.generated_numbers[0], 'no-float')}),
                        imgstr2: twig({ref: "imageholder"}).render({imgsrc: oImg.html(exercise.generated_numbers[1], 'no-float')})
                    }) 
                );
//                .append(twig({ref: "imageholder"}).render({imgsrc: oImg.html(exercise.generated_numbers[0])}))
//                .append(twig({ref: "imageholder"}).render({imgsrc: oImg.html(exercise.generated_numbers[1])}));
