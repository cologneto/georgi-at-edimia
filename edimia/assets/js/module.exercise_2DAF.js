var exercise = {
    ...
    set: function() {
        ...
        var oImg3 = new number_image({
            collection: "fruit",
            category: "still",
            type:frt[fruits_numb[2]]
        });
        
        var numbs = [_helper.rangeRandom(0,5)];
        numbs.push(_helper.rangeRandomSkipUsed(0,5,numbs));
        numbs.push(_helper.rangeRandomSkipUsed(0,5,numbs));
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
                ...
                mathsignclass: "large",
                num1: numbs[0], 
                imgstr1: twig({ref: "imageholder"}).render({imgsrc: oImg1.html(1,"still")}), 
                num2: numbs[1], 
                imgstr2: twig({ref: "imageholder"}).render({imgsrc: oImg2.html(1,"still")}),
                imgstr3: eval(numbs[0] + numbs[1]),
        ...
        $(".exe-container-question").append( 
           $( twig({ref: "equation"}).render({
                ...
                imgstr1: twig({ref: "imageholder"}).render({imgsrc: oImg1.html(1,"still")}), 
                num2: numbs[2], 
                imgstr2: twig({ref: "imageholder"}).render({imgsrc: oImg3.html(1,"still")}),
                imgstr3: eval(numbs[0] + numbs[2]),
                mathSignOperator: exercise.params.operationSign
                
            })).addClass("space-top")
        );   

        $(".exe-container-question").data("value",numbs[1]+numbs[2]).append( 
           $( twig({ref: "equation"}).render({
                classname: "",
                num1class: "has-text large",
                num2class: "has-text large",
