var exercise = {
    ...
    init: function() {
        ...
        var aConfigClasses = [
            "c0-5-d10",
            "layout no-header layout fluid cols-2 col-w66" 
        ];
    ...
    set: function() {
        ...
        $(".exe-container-answer").data("value", '').html( 
            twig({ref: "answer"}).render( {classname: "animated bounceInLeft has-text large value", content: parseInt( exercise.generated_numbers[0] - exercise.generated_numbers[1] ) } )
        );
        ...
        $("#exercise-drag-target-area").html( twig({ref: "dragitem"}).render({image: oImg.html(1, "answer-drag-item drag-img-small-right")}) );
