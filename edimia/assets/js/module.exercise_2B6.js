var exercise = {
    ...
    set: function() {
        ...
        var numb = _helper.rangeRandom(1,5); 
        exercise.generated_numbers = [numb,numb];
        ...
        var oImg1 = new number_image({
         ...
         $(".exe-container-header").data("value", exercise.generated_numbers[0] ).html(
            twig({ref: "imageholder"}).render({
                classname: "text-center img-contain-med",
                imgsrc: oImg1.html(exercise.generated_numbers[0],"no-float no-margin")
            })
        ).addClass("no-margin");
