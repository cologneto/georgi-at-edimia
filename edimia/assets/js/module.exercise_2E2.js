var exercise = {
    ...
    set: function() {
        ...
        var numb2;
        var sign;
        do{ numb2 = _helper.rangeRandom(exercise.params.min,numb);}
        while((numb + numb2) > exercise.params.max)
        exercise.generated_numbers = [numb , numb2];
        ...
        var Answers = [];
            ...
            $(".exe-container-question").append(
                $( twig({ref: "equation"}).render({
                    ...
                    num2: numb2, 
                    imgstr2: numb2,
                    imgstr3: twig({ref: "answercontainer"}).render({classname: "short dashed", value: eval(exercise.generated_numbers[0]+sign[0]+exercise.generated_numbers[1])}),
                    mathSignOperator: sign[0]
                }) ).attr("data-value", eval(exercise.generated_numbers[0]+sign[0]+exercise.generated_numbers[1]))
            );
            $(".exe-container-question").append(
                        $( twig({ref: "equation"}).render({
                            classname: '',
                            ...
                            num2: numb2, 
                            imgstr2: numb2,
                            imgstr3: twig({ref: "answercontainer"}).render({classname: "short dashed", value: eval(exercise.generated_numbers[0]+sign[1]+exercise.generated_numbers[1])}),
                            mathSignOperator: sign[1]
                        }) ).attr("data-value", eval(exercise.generated_numbers[0]+sign[1]+exercise.generated_numbers[1]))
                    );
            
        Answers.push(eval(exercise.generated_numbers[0]+sign[0]+exercise.generated_numbers[1]))
        Answers.push(eval(exercise.generated_numbers[0]+sign[1]+exercise.generated_numbers[1]))
        Answers.push(_helper.rangeRandomSkipUsed(exercise.params.min,exercise.params.max,Answers));
